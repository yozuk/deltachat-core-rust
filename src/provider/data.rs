...
static P_AKTIVIX_ORG: Lazy<Provider> = Lazy::new(|| Provider {
    ...
    server: vec![
        ...
        Server { protocol: Smtp, socket: Starttls, hostname: "newyear.aktivix.org", port: 587, username_pattern: Email },
    ],
    config_defaults: None,
    strict_tls: true,
    max_smtp_rcpt_to: None,
...
// aol.md: aol.com
static P_AOL: Lazy<Provider> = Lazy::new(|| Provider {
    id: "aol",
...
static P_BLINDZELN_ORG: Lazy<Provider> = Lazy::new(|| Provider {
    ...
    server: vec![
        Server { protocol: Imap, socket: Ssl, hostname: "webbox222.server-home.org", port: 993, username_pattern: Email },
        Server { protocol: Smtp, socket: Ssl, hostname: "webbox222.server-home.org", port: 465, username_pattern: Email },
    ],
    config_defaults: None,
    strict_tls: true,
    max_smtp_rcpt_to: None,
...
static P_BUZON_UY: Lazy<Provider> = Lazy::new(|| Provider {
    ...
    server: vec![
        Server { protocol: Imap, socket: Starttls, hostname: "mail.buzon.uy", port: 143, username_pattern: Email },
        Server { protocol: Smtp, socket: Starttls, hostname: "mail.buzon.uy", port: 587, username_pattern: Email },
    ],
    config_defaults: None,
    strict_tls: true,
    max_smtp_rcpt_to: None,
...
static P_DISROOT: Lazy<Provider> = Lazy::new(|| Provider {
    ...
    server: vec![
        Server { protocol: Imap, socket: Ssl, hostname: "disroot.org", port: 993, username_pattern: Email },
        Server { protocol: Smtp, socket: Starttls, hostname: "disroot.org", port: 587, username_pattern: Email },
    ],
    config_defaults: None,
    strict_tls: true,
    max_smtp_rcpt_to: None,
...
static P_E_EMAIL: Lazy<Provider> = Lazy::new(|| Provider {
    ...
    server: vec![
        Server { protocol: Imap, socket: Ssl, hostname: "mail.ecloud.global", port: 993, username_pattern: Email },
        Server { protocol: Smtp, socket: Starttls, hostname: "mail.ecloud.global", port: 587, username_pattern: Email },
    ],
    config_defaults: None,
    strict_tls: true,
    max_smtp_rcpt_to: None,
...
static P_EXAMPLE_COM: Lazy<Provider> = Lazy::new(|| Provider {
    id: "example.com",
    status: Status::Broken,
...
static P_FASTMAIL: Lazy<Provider> = Lazy::new(|| Provider {
    ...
    server: vec![
        Server { protocol: Imap, socket: Ssl, hostname: "imap.fastmail.com", port: 993, username_pattern: Email },
        Server { protocol: Smtp, socket: Ssl, hostname: "smtp.fastmail.com", port: 465, username_pattern: Email },
    ],
    config_defaults: None,
    strict_tls: true,
    max_smtp_rcpt_to: None,
...
static P_FIREMAIL_DE: Lazy<Provider> = Lazy::new(|| Provider {
    id: "firemail.de",
    status: Status::Preparation,
...
static P_GMAIL: Lazy<Provider> = Lazy::new(|| Provider {
    id: "gmail",
    status: Status::Preparation,
...
// hey.com.md: hey.com
static P_HEY_COM: Lazy<Provider> = Lazy::new(|| Provider {
    id: "hey.com",
    status: Status::Broken,
...
static P_INFOMANIAK_COM: Lazy<Provider> = Lazy::new(|| Provider {
    ...
    server: vec![
        Server { protocol: Imap, socket: Ssl, hostname: "mail.infomaniak.com", port: 993, username_pattern: Email },
        Server { protocol: Smtp, socket: Ssl, hostname: "mail.infomaniak.com", port: 465, username_pattern: Email },
    ],
    config_defaults: None,
    strict_tls: true,
...
static P_MAIL_DE: Lazy<Provider> = Lazy::new(|| Provider {
    ...
    server: vec![
        Server { protocol: Imap, socket: Ssl, hostname: "imap.mail.de", port: 993, username_pattern: Email },
        Server { protocol: Smtp, socket: Ssl, hostname: "smtp.mail.de", port: 465, username_pattern: Email },
    ],
    config_defaults: None,
    strict_tls: true,
    max_smtp_rcpt_to: None,
...
static P_MAIL2TOR: Lazy<Provider> = Lazy::new(|| Provider {
    ...
    server: vec![
        Server { protocol: Imap, socket: Plain, hostname: "g77kjrad6bafzzyldqvffq6kxlsgphcygptxhnn4xlnktfgaqshilmyd.onion", port: 143, username_pattern: Email },
        Server { protocol: Smtp, socket: Plain, hostname: "xc7tgk2c5onxni2wsy76jslfsitxjbbptejnqhw6gy2ft7khpevhc7ad.onion", port: 25, username_pattern: Email },
    ],
    config_defaults: None,
    strict_tls: true,
    max_smtp_rcpt_to: None,
...
static P_MAILBOX_ORG: Lazy<Provider> = Lazy::new(|| Provider {
    ...
    server: vec![
        Server { protocol: Imap, socket: Ssl, hostname: "imap.mailbox.org", port: 993, username_pattern: Email },
        Server { protocol: Smtp, socket: Ssl, hostname: "smtp.mailbox.org", port: 465, username_pattern: Email },
    ],
    config_defaults: None,
    strict_tls: true,
    max_smtp_rcpt_to: None,
...
static P_MAILO_COM: Lazy<Provider> = Lazy::new(|| Provider {
    ...
    server: vec![
        Server { protocol: Imap, socket: Ssl, hostname: "imap.mailo.com", port: 993, username_pattern: Email },
        Server { protocol: Smtp, socket: Ssl, hostname: "smtp.mailo.com", port: 465, username_pattern: Email },
    ],
    config_defaults: None,
    strict_tls: true,
    max_smtp_rcpt_to: None,
...
static P_NAVER: Lazy<Provider> = Lazy::new(|| Provider {
    ...
    server: vec![
        Server { protocol: Imap, socket: Ssl, hostname: "imap.naver.com", port: 993, username_pattern: Emaillocalpart },
        Server { protocol: Smtp, socket: Starttls, hostname: "smtp.naver.com", port: 587, username_pattern: Email },
    ],
    config_defaults: None,
    strict_tls: true,
    max_smtp_rcpt_to: None,
...
static P_OUTLOOK_COM: Lazy<Provider> = Lazy::new(|| Provider {
    ...
    server: vec![
        Server { protocol: Imap, socket: Ssl, hostname: "outlook.office365.com", port: 993, username_pattern: Email },
        Server { protocol: Smtp, socket: Starttls, hostname: "smtp.office365.com", port: 587, username_pattern: Email },
    ],
    config_defaults: None,
    strict_tls: true,
    max_smtp_rcpt_to: None,
...
static P_PROTONMAIL: Lazy<Provider> = Lazy::new(|| Provider {
    id: "protonmail",
    status: Status::Broken,
...
static P_QQ: Lazy<Provider> = Lazy::new(|| Provider {
    id: "qq",
    status: Status::Preparation,
...
static P_RISEUP_NET: Lazy<Provider> = Lazy::new(|| Provider {
    ...
    server: vec![
        Server { protocol: Imap, socket: Ssl, hostname: "mail.riseup.net", port: 993, username_pattern: Email },
        Server { protocol: Smtp, socket: Ssl, hostname: "mail.riseup.net", port: 465, username_pattern: Email },
    ],
    config_defaults: None,
    strict_tls: true,
    max_smtp_rcpt_to: None,
...
static P_SYSTEMAUSFALL_ORG: Lazy<Provider> = Lazy::new(|| Provider {
    ...
    server: vec![
        Server { protocol: Imap, socket: Ssl, hostname: "mail.systemausfall.org", port: 993, username_pattern: Email },
        Server { protocol: Smtp, socket: Ssl, hostname: "mail.systemausfall.org", port: 465, username_pattern: Email },
    ],
    config_defaults: None,
    strict_tls: true,
    max_smtp_rcpt_to: None,
...
static P_SYSTEMLI_ORG: Lazy<Provider> = Lazy::new(|| Provider {
    ...
    server: vec![
        Server { protocol: Imap, socket: Ssl, hostname: "mail.systemli.org", port: 993, username_pattern: Email },
        Server { protocol: Smtp, socket: Ssl, hostname: "mail.systemli.org", port: 465, username_pattern: Email },
    ],
    config_defaults: None,
    strict_tls: true,
    max_smtp_rcpt_to: None,
...
static P_T_ONLINE: Lazy<Provider> = Lazy::new(|| Provider {
    id: "t-online",
    status: Status::Preparation,
...
// try.webxdc.org.md: try.webxdc.org
static P_TRY_WEBXDC_ORG: Lazy<Provider> = Lazy::new(|| Provider {
    id: "try.webxdc.org",
    status: Status::Ok,
    before_login_hint: "",
    after_login_hint: "",
    overview_page: "https://providers.delta.chat/try-webxdc-org",
    server: vec![
        Server { protocol: Imap, socket: Ssl, hostname: "dc.develcow.de", port: 993, username_pattern: Email },
        Server { protocol: Smtp, socket: Starttls, hostname: "dc.develcow.de", port: 587, username_pattern: Email },
    ],
    config_defaults: None,
    strict_tls: true,
    max_smtp_rcpt_to: None,
...
static P_TUTANOTA: Lazy<Provider> = Lazy::new(|| Provider {
    id: "tutanota",
    status: Status::Broken,
...
static P_VIVALDI: Lazy<Provider> = Lazy::new(|| Provider {
    ...
    server: vec![
        Server { protocol: Imap, socket: Starttls, hostname: "imap.vivaldi.net", port: 143, username_pattern: Email },
        Server { protocol: Smtp, socket: Starttls, hostname: "smtp.vivaldi.net", port: 587, username_pattern: Email },
    ],
    config_defaults: None,
    strict_tls: true,
    max_smtp_rcpt_to: None,
...
static P_WEB_DE: Lazy<Provider> = Lazy::new(|| Provider {
    id: "web.de",
    status: Status::Preparation,
    before_login_hint: "You must allow IMAP access to your account before you can login.",
...
static P_YAHOO: Lazy<Provider> = Lazy::new(|| Provider {
    id: "yahoo",
    status: Status::Preparation,
...
// yggmail.md: yggmail
static P_YGGMAIL: Lazy<Provider> = Lazy::new(|| Provider {
    id: "yggmail",
    status: Status::Preparation,
...
static P_ZOHO: Lazy<Provider> = Lazy::new(|| Provider {
    ...
    server: vec![
        Server { protocol: Imap, socket: Ssl, hostname: "imap.zoho.eu", port: 993, username_pattern: Email },
        Server { protocol: Smtp, socket: Ssl, hostname: "smtp.zoho.eu", port: 465, username_pattern: Email },
    ],
    config_defaults: None,
    strict_tls: true,
    max_smtp_rcpt_to: None,
...
pub(crate) static PROVIDER_DATA: Lazy<HashMap<&'static str, &'static Provider>> = Lazy::new(|| [
    ...
    ("try.webxdc.org", &*P_TRY_WEBXDC_ORG),
...
pub static PROVIDER_UPDATED: Lazy<chrono::NaiveDate> = Lazy::new(|| chrono::NaiveDate::from_ymd(2022, 6, 11));
